...
P_GREEN="#86efac"; P_BLUE="#93c5fd"; TEXT_SEC="#8b949e"; TEXT_PRI="#e6edf3"
...
moedas_exib = ["USD","EUR","GBP","CHF","JPY","CAD","AUD"]
cols = st.columns(len(moedas_exib))
for i, m in enumerate(moedas_exib):
